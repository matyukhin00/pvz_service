...
//go:generate minimock -i github.com/matyukhin00/pvz_service/internal/utils.TokenGenerator -o token_generator_mock.go -n TokenGeneratorMock -p mocks
...
// TokenGeneratorMock implements mm_utils.TokenGenerator
type TokenGeneratorMock struct {
	t          minimock.Tester
	finishOnce sync.Once

	funcGenerateToken          func(info model.UserClaims, secretKey []byte, duration time.Duration) (s1 string, err error)
	funcGenerateTokenOrigin    string
	inspectFuncGenerateToken   func(info model.UserClaims, secretKey []byte, duration time.Duration)
	afterGenerateTokenCounter  uint64
	beforeGenerateTokenCounter uint64
	GenerateTokenMock          mTokenGeneratorMockGenerateToken
}

// NewTokenGeneratorMock returns a mock for mm_utils.TokenGenerator
...
type TokenGeneratorMockGenerateTokenExpectation struct {
	...
	expectationOrigins TokenGeneratorMockGenerateTokenExpectationOrigins
...
// TokenGeneratorMockGenerateTokenOrigins contains origins of expectations of the TokenGenerator.GenerateToken
type TokenGeneratorMockGenerateTokenExpectationOrigins struct {
	origin          string
	originInfo      string
...
func (mmGenerateToken *mTokenGeneratorMockGenerateToken) Expect(info model.UserClaims, secretKey []byte, duration time.Duration) *mTokenGeneratorMockGenerateToken {
...
func (mmGenerateToken *mTokenGeneratorMockGenerateToken) ExpectInfoParam1(info model.UserClaims) *mTokenGeneratorMockGenerateToken {
	if mmGenerateToken.mock.funcGenerateToken != nil {
		mmGenerateToken.mock.t.Fatalf("TokenGeneratorMock.GenerateToken mock is already set by Set")
	}
	...
	mmGenerateToken.defaultExpectation.expectationOrigins.originInfo = minimock.CallerInfo(1)
...
func (mmGenerateToken *mTokenGeneratorMockGenerateToken) Inspect(f func(info model.UserClaims, secretKey []byte, duration time.Duration)) *mTokenGeneratorMockGenerateToken {
...
func (mmGenerateToken *mTokenGeneratorMockGenerateToken) Set(f func(info model.UserClaims, secretKey []byte, duration time.Duration) (s1 string, err error)) *TokenGeneratorMock {
	if mmGenerateToken.defaultExpectation != nil {
...
// Then helper
func (mmGenerateToken *mTokenGeneratorMockGenerateToken) When(info model.UserClaims, secretKey []byte, duration time.Duration) *TokenGeneratorMockGenerateTokenExpectation {
	if mmGenerateToken.mock.funcGenerateToken != nil {
		mmGenerateToken.mock.t.Fatalf("TokenGeneratorMock.GenerateToken mock is already set by Set")
	}
	...
	expectation := &TokenGeneratorMockGenerateTokenExpectation{
		...
		expectationOrigins: TokenGeneratorMockGenerateTokenExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
// GenerateToken implements mm_utils.TokenGenerator
func (mmGenerateToken *TokenGeneratorMock) GenerateToken(info model.UserClaims, secretKey []byte, duration time.Duration) (s1 string, err error) {
	...
	if mmGenerateToken.GenerateTokenMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.info != nil && !minimock.Equal(*mm_want_ptrs.info, mm_got.info) {
				mmGenerateToken.t.Errorf("TokenGeneratorMock.GenerateToken got unexpected parameter info, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGenerateToken.GenerateTokenMock.defaultExpectation.expectationOrigins.originInfo, *mm_want_ptrs.info, mm_got.info, minimock.Diff(*mm_want_ptrs.info, mm_got.info))
			}

			if mm_want_ptrs.secretKey != nil && !minimock.Equal(*mm_want_ptrs.secretKey, mm_got.secretKey) {
				mmGenerateToken.t.Errorf("TokenGeneratorMock.GenerateToken got unexpected parameter secretKey, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
			...
			if mm_want_ptrs.duration != nil && !minimock.Equal(*mm_want_ptrs.duration, mm_got.duration) {
				mmGenerateToken.t.Errorf("TokenGeneratorMock.GenerateToken got unexpected parameter duration, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
			...
			mmGenerateToken.t.Errorf("TokenGeneratorMock.GenerateToken got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
...
func (m *TokenGeneratorMock) MinimockGenerateTokenInspect() {
	for _, e := range m.GenerateTokenMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to TokenGeneratorMock.GenerateToken at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if !m.GenerateTokenMock.invocationsDone() && afterGenerateTokenCounter > 0 {
		m.t.Errorf("Expected %d calls to TokenGeneratorMock.GenerateToken at\n%s but found %d calls",
